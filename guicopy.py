...
original=Text(root, height=10, width=40)
translated=Text(root, height=10, width=40)
button2= Button(root, text="Translate",  padx = 5, pady = 5, command=Translate )
button3=Button(root, text="Clear", padx=5, pady=5, command=clear)
...
original.grid(row=4, column=0)
translated.grid(row=6,column=0)
